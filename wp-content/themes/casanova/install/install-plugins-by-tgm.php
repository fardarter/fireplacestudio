...
add_action( 'tgmpa_register', '__theme_register_required_plugins' );
/**
 ...
 */
function __theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name' => 'Shortcodes for Casanova Theme',
            'slug' => 'casanova-core',
            'source' => dirname(__FILE__).'/zips/casanova-core.zip',
            'required' => true,
        ),
        array(
            'name' => 'WPBakery Visual Composer',
            'slug' => 'js_composer',
            'source' => dirname(__FILE__).'/zips/js_composer.zip',
            'required' => true,
        ),
        array(
            'name' => 'Revolution Slider',
            'slug' => 'revslider',
            'source' => dirname(__FILE__).'/zips/revslider.zip',
            'required' => true,
        ),
        array(
        ...
        array(
            ...
            'source' => dirname(__FILE__).'/zips/fresh-custom-loops.zip',
            'required' => false,
        ),
        array(
            'name' => 'Fresh Favicon',
        ...
        array(
            ...
            'source' => dirname(__FILE__).'/zips/fresh-scrollbar.zip',
            'required' => false,
        ),
        array(
            'name' => 'Fresh Sidebar Manager',
            'slug' => 'fresh-sidebar-manager',
            'source' => dirname(__FILE__).'/zips/fresh-sidebar-manager.zip',
            'required' => false,
        ),
